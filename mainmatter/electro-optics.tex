...
The second key result of the work is \textbf{a FOM that can be evaluated by solving a single reciprocal problem} (\secref{sec:nanophotonics}) where the system is excited from then output port~\cite{ownpub4}
