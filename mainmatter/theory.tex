...
\end{align}
EXPLAIN EPSILON AND MU AND REFRACTIVE INDEX. MAY EXPLAIN THAT THE IMAGINARY PART IS ENERGY DISSIPATION FOR BOTH?WRItE RELATION LIKE INTERP AND ALSO REFERENCE IT LATER. where $\varepsilon_0$ is the permittivity of free space and $\mu_0$ is the
