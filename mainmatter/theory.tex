...
%    \end{figure}
 ...
 in~\secref{sec:nanophotonics}.}, in the general case where there are optical losses [in materials ($\varepsilon_r^{\prime \prime} \neq 0$), or boundary conditions] the stiffness matrix is a sparse symmetric indefinite matrix,
 ...
 the adjoint problem (e.g., \eqref{eq:adjoint_eqs} in~\secref{sec:topopt_theory}). To reduce the computational cost of solving the system of equations in~
