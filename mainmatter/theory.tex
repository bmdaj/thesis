...
This chapter lays out the theoretical foundations used throughout the thesis and is divided into four main sections. The first section (\secref{sec:nanophotonics}) covers the fundamental physics governing nanophotonic problems in the single-physics picture. The second section (\secref{sec:fem}) provides background on solving nanophotonic problems numerically using the finite element method. The third section (\secref{sec:coupled}) presents the concept of coupled nanophotonic systems in multiphysics picture. Finally, the fourth section (\secref{sec:topopt_theory}) presents a framework for topology optimization of multiphysics systems.
